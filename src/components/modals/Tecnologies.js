...
import css from './css/Tecnologies.module.css';

export const Technologies = () => {
    return (
        <div id="technologies" className={css.technologiesDiv}>
            <h2 className={scss.littleTitle}>Keeping it natural</h2>
            <p>
            ...
            <div>
                ...
                <div>
                    ...
                    <p>
                        “We didn’t start by thinking we’ll do a natural product,
                        gelato has always been made like this in Italy,” said
                        Langstone. “We’re fresh and natural, and I can’t say if
                        that’s the reason behind our increasing our sales, but
                        they certainly are increasing because we keep opening
                        more shops.”
                    </p>
                </div>
            </div>
            ...
            <h2 className={scss.littleTitle}>The all natural debate</h2>
            <p>
                One company which famously lost out on keeping its ‘all natural’
                claim with regard to their ice creams is Ben & Jerry’s.
            </p>
            <div>
                <h3>
